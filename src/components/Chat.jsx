...
const Chat = () => {
    ...
    return (
        /* Adjusting main container for mobile to prevent content being hidden under the fixed input */
        <div className='max-w-5xl mx-auto border border-black h-[85vh] md:h-[80vh] flex bg-white overflow-hidden shadow-none md:shadow-[20px_20px_0px_0px_rgba(0,0,0,1)]'>
            ...
            <div className='flex-1 flex flex-col relative w-full'>
                ...
                {/* Messages View */}
                {/* pb-32 on mobile ensures the last message is scrollable above the floating input */}
                <div className='flex-1 overflow-y-auto p-4 md:p-8 space-y-4 md:space-y-6 bg-[#FAFAFA] pb-32 md:pb-8'>
                ...
                {/* --- UPDATED TERMINAL INPUT --- */}
                {/* fixed bottom-[64px] lifts it above your footer items. md:static puts it back for laptop. */}
                <div className='fixed bottom-[64px] left-0 w-full md:static md:bottom-auto p-4 md:p-6 border-t border-black bg-white flex items-center gap-2 md:gap-4 z-50'>
